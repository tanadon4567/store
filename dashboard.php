                                    ...
                                    <div class="card card-custom gutter-b card-stretch">
                                        ...
                                        <div class="card-body d-flex flex-column p-0">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="symbol-label">
                                                                <span class="svg-icon svg-icon-lg svg-icon-warning">
                                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Devices/Mic.svg--><svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        width="24px" height="24px" viewBox="0 0 24 24"
                                                                        version="1.1">
                                            ...
                                            <div id="kt_tiles_widget_8_chart" class="card-rounded-bottom"
                                                data-color="warning" style="height: 150px"></div>
                                            <!--end::Chart-->
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                                    ...
                                                    <thead>
                                                        <tr class="text-left">
                                                            <th class="pl-0" style="width: 30px">
                                                                <label
                                                                    class="checkbox checkbox-lg checkbox-inline mr-2">
                                    ...
                                    <div class="card card-custom gutter-b card-stretch">
                                        ...
                                        <div class="card-body pt-2">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-10">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#"
                                                        ...
                                                        Apartments</a>
                                                    <span class="text-muted font-weight-bold">2 bed, 1 bath, 1
                                                        carpark</span>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-10">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#"
                                                        ...
                                                        Apartments</a>
                                                    <span class="text-muted font-weight-bold">2 bed, 2 bath, 1
                                                        carpark</span>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-10">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('assets/media/stock-600x400/img-22.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#"
                                                        class="text-dark font-weight-bold text-hover-primary mb-1 font-size-lg">421
                                                        Avenue</a>
                                                    <span class="text-muted font-weight-bold">3 bed, 1 bath, 1
                                                        carpark</span>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    ...
                                                    <span class="text-muted font-weight-bold">4 bed, 3 bath, 1
                                                        carpark</span>
                                                </div>
                                                <!--end::Title-->
