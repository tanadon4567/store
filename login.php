            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">
                        ระบบจัดการศูนย์ซ่อมสร้างเพื่อชุมชน<br />
                        Fixit Center @ SPVC
                    </h3>
                    <!--end::Aside title-->
                </div>
            ...
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        <!--begin::Form-->
                        <form class="form" action="api/ac_login.php?ac=login" method="POST" id="frm_login"
                            ENCTYPE="multipart/form-data">
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">
                                    ลงชื่อเข้าใช้งานระบบ</h3>
                                <span class="text-muted font-weight-bold font-size-h4">สมัครสมาชิก <a
                                        href="javascript:;" id="kt_login_signup"
                                        class="text-primary font-weight-bolder">คลิกที่นี่</a></span>
                            </div>
                            <!--begin::Title-->

                            <!--begin::Form group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">ชื่อผู้ใช้</label>
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    <label class="font-size-h6 font-weight-bolder text-dark pt-5">รหัสผ่าน</label>
                            ...
                            <div class="pb-lg-0 pb-5">
                                <button type="submit" id="btn_submit"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">เข้าสู่ระบบ</button>
...
$(document).on("submit", "#frm_login", function(event) {
    ...
    if ($("#username").val() == "") {
        ...
        alert("กรุณากรอกชื่อรหัสผ่านด้วย");
        $("#password").focus();
    } else {
